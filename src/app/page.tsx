...
export default async function Home() {
  ...
  return <main id="conteudo" className="subtle-grid relative min-h-screen overflow-hidden px-5 py-5 md:px-8 md:py-7">
    ...
    <section className="relative mx-auto max-w-6xl pb-8 pt-16 text-center md:pb-10 md:pt-20">
      <p className="font-mono text-[10px] uppercase tracking-[.22em] text-[#8ea7ff]">Inteligência de indicação</p>
      <h1 className="gradient-text mx-auto mt-5 max-w-4xl text-4xl font-medium leading-[1.08] tracking-[-.035em] sm:text-5xl md:text-6xl">Um ponto de entrada.<br/>Duas experiências privadas.</h1>
    ...
    <section id="acessos" aria-label="Escolha seu tipo de acesso" className="relative mx-auto grid max-w-5xl gap-5 lg:grid-cols-2">
      <article className="access-card group relative overflow-hidden rounded-3xl border border-[#35415f] bg-[linear-gradient(145deg,rgba(19,24,39,.96),rgba(12,14,20,.96))] p-6 shadow-2xl shadow-black/20 md:p-8">
        ...
        <div className="relative">
          ...
          <p className="mt-3 min-h-12 text-sm leading-6 text-[var(--muted)]">Crie oportunidades, mobilize sua equipe e acompanhe apenas candidatos compartilhados com consentimento.</p>
      ...
      <article className="access-card group relative overflow-hidden rounded-3xl border border-[#2e4c43] bg-[linear-gradient(145deg,rgba(16,30,27,.9),rgba(12,14,20,.97)_58%)] p-6 shadow-2xl shadow-black/20 md:p-8">
        ...
        <div className="relative">
          ...
          <p className="mt-3 min-h-12 text-sm leading-6 text-[var(--muted)]">Encontre pessoas relevantes para vagas reais sem expor sua lista de contatos ao administrador.</p>
