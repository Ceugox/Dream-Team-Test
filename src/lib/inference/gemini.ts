...
export async function inferStructuredGemini<T>(input:{schema:Record<string,unknown>;validator:z.ZodType<T>;system:string;payload:unknown;maxTokens?:number;signal?:AbortSignal}):Promise<StructuredInference<T>>{
